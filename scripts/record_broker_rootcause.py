...
ev = {
 ...
 "context_prefix": "[Escopo: HCL Workload Automation 10.2.8 (Distributed) > Componente: SwitchPlan / Dynamic Workload Broker > Interface: script SwitchPlan e CLI conman > Topico: troubleshooting > plan_recovery [broker_stop_unsupported]]"
}
